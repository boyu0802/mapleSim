...
public class MapleSimSwerveDrivetrain {
    ...
    public MapleSimSwerveDrivetrain(
        ...
        mapleSimDrive = new SwerveDriveSimulation(simulationConfig, new Pose2d(3.2, 1.02, Rotation2d.kZero));
    ...
    public static class TalonFXMotorControllerSim implements SimulatedMotorController {
        ...
        public Voltage updateControlSignal(
            ...
            // SmartDashboard.putNumber("TalonFX " + id + " Mech Angle", mechanismAngle.in(Rotations));
            // SmartDashboard.putNumber("TalonFX " + id + " Mech Vel", mechanismVelocity.in(RotationsPerSecond));
            // SmartDashboard.putNumber("TalonFX " + id + " Enc Angle", encoderAngle.in(Rotations));
            // SmartDashboard.putNumber("TalonFX " + id + " Enc Vel", encoderVelocity.in(RotationsPerSecond));
    ...
    private static void regulateModuleConstantForSimulation(SwerveModuleConstants<?, ?, ?> moduleConstants) {
        ...
        moduleConstants
                ...
                .withSteerInertia(KilogramSquareMeters.of(0.35));
    }
}